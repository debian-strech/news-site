...
$dbss['user']='roswel';      // Database user
$dbss['pass']='roswel';      // Database password
$dbss['name']='roswel';      // Database name. Note that the installation script cannot create a database for you!
